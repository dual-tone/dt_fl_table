...
class DTFLTableView extends DTFLTableState {
  ...
  List<Widget> _buildLeadingFixedHeaderColumn({
    required List<DTFLTableColumn> fixedLeadingColumns,
      ...
      ...(fixedLeadingColumns.map((col) {
        ...
        return SingleChildScrollView(
          ...
          child: Wrap(
            direction: Axis.vertical,
            children: List.generate(rows.length, (i) {
              DTFLTableRow currentRow = rows[i];
  ...
  _buildTrailingFixedHeaderColumn({
    required List<DTFLTableColumn> fixedTrailingColumns,
    required double availableWidth,
    double? defaultColumnWidth,
  }) {
  ...
  _buildHeaderColumn({
    required List<DTFLTableColumn> unfixedColumns,
    required double availableWidth,
    double? defaultColumnWidth,
  }) {
      ...
      return Container(
        ...
        child: Row(
          children: List.generate(unfixedColumns.length, (j) {
            DTFLTableColumn currentColumn = unfixedColumns[j];
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        List<DTFLTableColumn> fixedLeadingColumns = widget.columns
            .where((c) =>
                c.fixed != null && c.fixed == DTFLTableColumnFixedPosition.leading)
            .toList();
        List<DTFLTableColumn> fixedTrailingColumns = widget.columns
            .where((c) =>
                c.fixed != null &&
                c.fixed == DTFLTableColumnFixedPosition.trailing)
            .toList();
        List<DTFLTableColumn> unfixedColumns =
